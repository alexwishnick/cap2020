...
const fragmentShader1 = readFileSync(__dirname + '/shaders/blackandwhite.frag', 'utf8')
const fragmentShader2 = readFileSync(__dirname + '/shaders/meshbasic2.frag', 'utf8')
...
// create the geometry for material
...
var geometry = new THREE.PlaneGeometry(1, 1);
var material1 = new CustomMaterial({
	map: texture,
	vertexShader: vertexShader,
...
var geometry = new THREE.PlaneGeometry(1, 1);
var material2 = new CustomMaterial({
	map: texture,
	vertexShader: vertexShader,
...
window.addEventListener('resize', e => {
	...
	// assign the new material to the plane(mesh)
